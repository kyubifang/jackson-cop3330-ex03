...
public class App {
    ...
    public static void main(String[] args) {
        ...
        String origin = myApp.readOrigin();
        String outputString = myApp.generateOutputString(quote, origin);
    ...
    public String generateOutputString(String quote, String origin) {
        return origin + " says, \"" + quote + "\"";
    }
}
